...
const translations = {
    'fr': {
        ...
        'story_text': 'Je transforme la <a href="https://fr.wikipedia.org/wiki/Pens%C3%A9e_complexe" target="_blank" class="underline hover:opacity-70 transition">complexité</a> en opportunité stratégique. En tant que futur Chef de Projet Innovation, je conçois des écosystèmes complets où la créativité devient un levier de production de valeur. Admis au Mastère Spécialisé de l\'<a href="https://em-lyon.com/" target="_blank" class="underline hover:opacity-70 transition">emlyon</a>, je recherche une alternance dès 09/2026 pour structurer vos projets complexes.',
    ...
    'en': {
        ...
        'story_text': 'I transform <a href="https://fr.wikipedia.org/wiki/Pens%C3%A9e_complexe" target="_blank" class="underline hover:opacity-70 transition">complexity</a> into strategic opportunity. As a future Innovation Project Manager, I build ecosystems where creativity becomes a lever for value production. Joining <a href="https://em-lyon.com/" target="_blank" class="underline hover:opacity-70 transition">emlyon</a>, I am available from 09/2026 to bridge the gap between design intelligence and business strategy.',
    ...
    'it': {
        ...
        'story_text': 'Trasformo la <a href="https://fr.wikipedia.org/wiki/Pens%C3%A9e_complexe" target="_blank" class="underline hover:opacity-70 transition">complessità</a> in opportunità strategica. Come futuro Innovation Project Manager, concepisco interi ecosistemi dove la creatività diventa un asset strategico d\'impresa. Prossimo specializzando all\'<a href="https://em-lyon.com/" target="_blank" class="underline hover:opacity-70 transition">emlyon</a> in gestione strategica dell\'innovazione, cerco un\'alternanza dal 09/2026 per strutturare i vostri progetti complessi.',
